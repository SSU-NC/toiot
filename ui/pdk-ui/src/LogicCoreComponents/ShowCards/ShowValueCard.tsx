...
import { numRange, logicElem,lcValueArg } from '../../ElemInterface/LcElementsInterface';
            ...
            <div className="card margin-bottom">
				<div className="card-body row">
					<div className="col-2 right-divider">
						<span style={{fontSize:'15pt', fontWeight:500}} >value #{this.props.index}</span>
					</div>
					...
					<div>
						{range.map((range: numRange, idx: number) => (
							<div>
								...
								<br/>
								<span style={{fontSize:'15pt'}}>: {range.min} &lt; {value_name} &lt; {range.max}</span>
							</div>
						))}
					</div>
				</div>
