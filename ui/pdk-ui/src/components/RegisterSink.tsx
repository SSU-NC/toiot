...
class RegisterSink extends Component<{}, RegisterSinkState> {
    ...
    render() {
        return (
            ...
            <div className="modal fade" id="register-sink-modal" role="dialog" aria-labelledby="register-sink-modal">
                <div className="modal-dialog" role="document">
                    <div className="modal-content">
                        <div className="modal-header"> 
                            <h4 className="modal-title" id="register-sink-modal">Register sink</h4>
                            <button 
                                type="button" 
                                className="close" 
                                data-dismiss="modal" 
                        ...
                        <form>
                            ...
                            <div className="modal-footer">
                                <button type="submit" className="btn btn-primary" data-dismiss="modal" onClick={this.handleSubmit}>Submit</button>
